...
void DrawNextPuyo() {
    DrawPuyo(2, GetCol() + 1, nextPuyoSet[cPuyoIndex].main);
    DrawPuyo(1, GetCol() + 1, nextPuyoSet[cPuyoIndex].sub);

    DrawPuyo(5, GetCol() + 1, nextPuyoSet[cPuyoIndex + 1].main);
    DrawPuyo(4, GetCol() + 1, nextPuyoSet[cPuyoIndex + 1].sub);
}
void DrawMoveable() {
